...
import banner from '../../../assets/sectionImages/womanCare/WomensCare.jpg';
import product1 from '../../../assets/sectionImages/womanCare/Freedom.jpg';
import product2 from '../../../assets/sectionImages/womanCare/getwell get.jpg';
import product3 from '../../../assets/sectionImages/womanCare/good news digital.jpg';
import product4 from '../../../assets/sectionImages/womanCare/joya.png';
import product5 from '../../../assets/sectionImages/womanCare/New whisper.jpg';
import product6 from '../../../assets/sectionImages/womanCare/Norix 1.jpg';
import product7 from '../../../assets/sectionImages/womanCare/senora confidence.jpg';
import product8 from '../../../assets/sectionImages/womanCare/veet.jpg';
import product9 from '../../../assets/sectionImages/womanCare/Vwash.jpg';
...
const WomansCareSection = () => {
    return (
        <div className="w-full ">
        <h1 className='text-center p-3 text-4xl font-bold text-gray-600 mb-5'>Womans Care</h1>
                ...
                <div className='h-24 sm:h-60  bg-gradient-to-r from-teal-400 to-teal-200 p-0 sm:p-4 flex flex-col justify-between'>
                    <div className='space-y-0 sm:space-y-2'>
                        ...
                        <p className='text-gray-500 font-semibold text-xs sm:text-base'>
                            Discover a comprehensive selection of diabetic care products at MediCostCompare, <span className="hidden sm:block">tailored to support the management and well-being of individuals living with diabetes. From glucose meters to insulin pens, find everything you need to monitor, manage, and maintain a healthy lifestyle.</span>
                        </p>
                    </div>
...
export default WomansCareSection;